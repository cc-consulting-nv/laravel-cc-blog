  ...
  _map(e, t, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= u) {
        ...
        return (t < 0 ? e != a : e != u) && (m |= Ls), new nr(d, m, p);
      }
      i += h - c;
    }
...
class L extends K {
  ...
  */
  ...
  map(e) {
    let t = e.mapResult(this.from, 1), r = e.mapResult(this.to, -1);
    return t.deletedAcross && r.deletedAcross ? null : new L(t.pos, Math.max(t.pos, r.pos), this.slice, this.structure);
  }
  merge(e) {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new L(t.from, t.to, b.fromJSON(e, t.slice), !!t.structure);
  }
}
K.jsonID("replace", L);
class F extends K {
  ...
  */
  static fromJSON(e, t) {
    ...
    return new F(t.from, t.to, t.gapFrom, t.gapTo, b.fromJSON(e, t.slice), t.insert, !!t.structure);
  }
}
  ...
  for (let a = 0; a < s.childCount; a++) {
    ...
    if (!u)
      ...
      if (i && c.isText && t.whitespace != "pre") {
        let f, d = /\r?\n|\r/g, p;
        for (; f = d.exec(c.text); )
          p || (p = new b(k.from(t.schema.text(" ", t.allowedMarks(c.marks))), 0, 0)), o.push(new L(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = h;
  }
...
function sa(n, e, t) {
  ...
  n.step(new F(a, c, o, l, new b(h.append(f), u, d), h.size - u, !0));
}
...
function aa(n, e, t) {
  ...
  n.step(new F(i, s, i, s, new b(r, 0, 0), t.length, !0));
}
function ca(n, e, t, r, i) {
  ...
  n.doc.nodesBetween(e, t, (o, l) => {
    ...
    if (o.isTextblock && !o.hasMarkup(r, a) && ha(n.doc, n.mapping.slice(s).map(l), r)) {
      ...
      return n.step(new F(u, f, u + 1, f - 1, new b(k.from(r.create(a, null, o.marks)), 0, 0), 1, !0)), c === !0 && Fs(n, o, l, s), !1;
    }
  });
}
function Fs(n, e, t, r) {
...
function ua(n, e, t, r, i) {
  ...
  n.step(new F(e, e + s.nodeSize, e + 1, e + s.nodeSize - 1, new b(k.from(o), 0, 0), 1, !0));
}
...
function fa(n, e, t = 1, r) {
  ...
  n.step(new L(e, e, new b(s.append(o), t, t), !0));
}
function ze(n, e) {
...
function pa(n, e, t) {
  ...
  if (n.step(new L(c, a.map(e + t, -1), b.empty, !0)), r === !0) {
    let h = n.doc.resolve(c);
    Fs(n, h.node(), h.before(), n.steps.length);
  }
  return n;
}
function ma(n, e, t) {
...
function xn(n, e, t = e, r = b.empty) {
  ...
  return Ws(i, s, r) ? new L(e, t, r) : new ya(i, s, r).fit();
}
function Ws(n, e, t) {
...
class ya {
  ...
  fit() {
    ...
    let a = new b(s, o, l);
    return e > -1 ? new F(r.pos, e, this.$to.pos, this.$to.end(), a, t) : a.size || r.pos != this.$to.pos ? new L(r.pos, i.pos, a) : null;
  }
  ...
  findFittable() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let r = t == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let i, s = null;
        r ? (s = Ln(this.unplaced.content, r - 1).firstChild, i = s.content) : i = this.unplaced.content;
        let o = i.firstChild;
  ...
  openMore() {
    let { content: e, openStart: t, openEnd: r } = this.unplaced, i = Ln(e, t);
  ...
  mustMoveInline() {
    ...
    if (!e.type.isTextblock || !Fn(this.$to, this.$to.depth, e.type, e.match, !1) || this.$to.depth == this.depth && (t = this.findCloseLevel(this.$to)) && t.depth == this.depth)
      return -1;
  ...
  findCloseLevel(e) {
    e: for (let t = Math.min(this.depth, e.depth); t >= 0; t--) {
      let { match: r, type: i } = this.frontier[t], s = t < e.depth && e.end(t + 1) == e.pos + (e.depth - (t + 1)), o = Fn(e, t, i, r, s);
      if (o) {
        for (let l = t - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], h = Fn(e, l, c, a, !0);
          if (!h || h.childCount)
            continue e;
        }
...
function gi(n, e, t) {
  ...
  if (r < e)
    return;
  let i = n.steps[r];
  if (!(i instanceof L || i instanceof F))
    return;
...
function so(n, e, t, r) {
  ...
  if (c && (o = (l = i.contentMatchAt(i.childCount)).findWrapping(s.type)) && l.matchType(o[0] || s.type).validEnd) {
    if (t) {
      ...
      p = k.from(i.copy(p));
      let m = n.tr.step(new F(e.pos - 1, d, e.pos, d, new b(p, 1, 0), o.length, !0)), g = m.doc.resolve(d + 2 * o.length);
    ...
    if (d.canReplace(d.childCount, d.childCount, m.content)) {
      if (t) {
        ...
        for (let S = p.length - 1; S >= 0; S--)
          y = k.from(p[S].copy(y));
        let x = n.tr.step(new F(e.pos - p.length, e.pos + s.nodeSize, e.pos + g, e.pos + s.nodeSize - g, new b(y, p.length, 0), 0, !0));
        t(x.scrollIntoView());
      }
      return !0;
    }
...
function Wa(n, e, t, r, i) {
  ...
  n.step(new F(e.start - (r ? 2 : 0), e.end, e.start, e.end, new b(s, 0, 0), t.length, !0));
  let o = 0;
...
function Ha(n, e, t, r) {
  ...
  s < o && (i.step(new F(s - 1, o, s, o, new b(k.from(t.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new nn(i.doc.resolve(r.$from.pos), i.doc.resolve(o), r.depth));
  const l = ft(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function ja(n, e, t) {
  ...
  return r.step(new F(u - (l ? 1 : 0), f + (a ? 1 : 0), u + 1, f - 1, new b((l ? k.empty : k.from(i.copy(k.empty))).append(a ? k.empty : k.from(i.copy(k.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function Ja(n) {
  return function(e, t) {
    ...
    if (t) {
      ...
      t(e.tr.step(new F(f - (c ? 3 : 1), d, f, d, u, 1, !0)).scrollIntoView());
    }
    return !0;
  };
}
  ...
  markDirty(e, t) {
    for (let r = 0, i = 0; i < this.children.length; i++) {
      ...
      if (r == o ? e <= o && t >= r : e < o && t > r) {
        ...
        if (e >= l && t <= a) {
          this.dirty = e == r || t == o ? Fe : vi, e == l && t == a && (s.contentLost || s.dom.parentNode != this.contentDOM) ? s.dirty = de : s.markDirty(e - l, t - l);
          return;
        } else
...
class Re extends Lt {
  ...
  updateChildren(e, t) {
    ...
    }), a.syncToMarks([], r, e, 0), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == Fe) && (o && this.protectLocalComposition(e, o), bo(this.contentDOM, this.children, e), ht && Mc(this.dom));
  }
    ...
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof Re) {
        ...
        if (!f && (u = this.recreateWrapper(a, e, t, r, i, o)))
          return this.destroyBetween(this.index, l), this.top.children[this.index] = u, u.contentDOM && (u.dirty = Fe, u.updateChildren(i, o + 1), u.dirty = re), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
...
function Pc(n, e) {
  ...
  if (t == 37 || ee && t == 66 && r == "c") {
    ...
    if (t == 38 || ee && t == 80 && r == "c")
      return Li(n, -1, r) || et(n, -1);
    if (t == 40 || ee && t == 78 && r == "c")
      return Rc(n) || Li(n, 1, r) || et(n, 1);
...
Z.dragstart = (n, e) => {
  ...
  (!t.dataTransfer.files.length || !H || ao > 120) && t.dataTransfer.clearData(), t.dataTransfer.setData(Dt ? "Text" : "text/html", a.innerHTML), t.dataTransfer.effectAllowed = "copyMove", Dt || t.dataTransfer.setData("text/plain", c), n.dragging = new Bo(h, Lo(n, t), o);
};
Z.dragend = (n) => {
  let e = n.dragging;
  window.setTimeout(() => {
...
var Lh = Object.defineProperty, Br = (n, e) => {
  for (var t in e)
    Lh(n, t, { get: e[t], enumerable: !0 });
};
function Tn(n) {
...
var Fh = () => ({ editor: n, view: e }) => (requestAnimationFrame(() => {
  var t;
...
var xu = (n, e) => ({ tr: t, state: r, dispatch: i }) => {
  ...
  return !0;
}, Mu = () => ({ state: n, dispatch: e }) => Qs(n, e), Cu = () => ({ state: n, dispatch: e }) => to(n, e), Tu = () => ({ state: n, dispatch: e }) => za(n, e), Eu = () => ({ state: n, dispatch: e }) => La(n, e), Nu = () => ({ state: n, dispatch: e }) => Ba(n, e);
function pr(n, e, t = {}, r = {}) {
  return Pt(n, e, {
    slice: !1,
    parseOptions: t,
...
function Fu(n, e) {
  ...
  return t === "node" ? Lu(n, e) : t === "mark" ? Zo(n, e) : {};
}
...
function tl(n, e, t) {
  ...
  return n === e ? t.resolve(n).marks().forEach((i) => {
    const s = t.resolve(n), o = Fr(s, i.type);
    o && r.push({
      mark: i,
      ...o
    });
...
var tf = ({ keepMarks: n = !0 } = {}) => ({ tr: e, state: t, dispatch: r, editor: i }) => {
  ...
  if (h && o) {
    let { from: f, to: d } = l;
    const p = (s = c.marks().find((g) => g.type === a)) == null ? void 0 : s.attrs, m = Fr(c, a, p);
...
var Af = (n) => "touches" in n, Gd = class {
  /**
...
Br(Df, {
  ...
  renderNestedMarkdownContent: () => Lf,
...
`), t = {};
  ...
  for (; e[0] !== void 0; ) {
    ...
    if (!o)
      break;
    const l = Dd[o[1].trim().toLowerCase()], a = o[2].trim();
    if (r = !0, e.shift(), !(!l || a === "")) {
      if (l === "status") {
        const c = Rd(a);
        c && (t.status = c);
        ...
        props: {
          handlePaste(e, t) {
            ...
            if (s && new DOMParser().parseFromString(s, "text/html").body.querySelector("h1,h2,h3,h4,h5,h6,strong,em,ul,ol,table,a[href]"))
              return !1;
            t.preventDefault();
            const { bodyMarkdown: o, hasDocumentMetadata: l, metadata: a } = zd(i), c = l ? o : i, h = R.parse(c, { async: !1 });
            return Ld(n, a), l && n.commands.clearContent(), c.trim() !== "" && n.commands.insertContent(h, {
